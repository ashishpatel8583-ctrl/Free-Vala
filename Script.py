...
ɪ ᴀᴍ ᴛʜᴇ ᴍᴏꜱᴛ ᴘᴏᴡᴇʀꜰᴜʟʟ ᴍᴇᴅɪᴀ ᴘʀᴏᴠɪᴅᴇʀ ʙᴏᴛ. ɪ ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇᴅ ᴀʟʟ ʟᴀᴛᴇꜱᴛ ᴍᴏᴠɪᴇꜱ ᴏʀ ꜱᴇʀɪᴇꜱ. ᴊᴜꜱᴛ ꜱᴇɴᴅ ᴍᴇ ᴛʜᴇ ᴄᴏʀʀᴇᴄᴛ ɴᴀᴍᴇ .</b>"""
    ...
    ABOUT_TXT = """<b>If your facing any problem with our bot and need help, So please contact Us

 🕛 Time : 8:AM To 10:PM

  Only For Urgent Problems, No Timepass</b>"""
...
1:- ʏᴏᴜ ᴍᴜꜱᴛ ʜᴀᴠᴇ ᴀᴛʟᴇᴀꜱᴛ ᴏɴᴇ ɢʀᴏᴜᴘ ᴡɪᴛʜ ᴍɪɴɪᴍᴜᴍ 1 ᴍᴇᴍʙᴇʀꜱ.
...
4:- ᴛʜᴇɴ CLICK @group_owner_command ᴄommand ᴀɴᴅ ᴇᴅɪᴛ ꜱᴇᴛᴛɪɴɢꜱ ᴀꜱ ʏᴏᴜʀ ᴡɪꜱᴇ
...
💯 ɴᴏᴛᴇ - ᴛʜɪs ʙᴏᴛ ɪs ꜰʀᴇᴇ ᴛᴏ ᴀʟʟ, ʏᴏᴜ ᴄᴀɴ ᴜsᴇ ᴛʜɪs ʙᴏᴛ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘs ᴀɴᴅ ᴇᴀʀɴ ᴜɴʟɪᴍɪᴛᴇᴅ ᴍᴏɴᴇʏ.</i></b>"""    
    ...
    VERIFICATION_TEXT = """<b><i>👋 ʜᴇʏ {} ɢᴏᴏᴅ ᴍᴏʀɴɪɴɢ ,

📌 ʏ̲ᴏ̲ᴜ̲ ̲ᴀ̲ʀ̲ᴇ̲ ̲ɴ̲ᴏ̲ᴛ̲ ̲ᴠ̲ᴇ̲ʀ̲ɪ̲ꜰ̲ɪ̲ᴇ̲ᴅ̲,̲ ̲ᴛ̲ᴀ̲ᴘ̲ ̲ᴏ̲ɴ̲ ̲ᴛ̲ʜ̲ᴇ̲ ̲ᴠ̲ᴇ̲ʀ̲ɪ̲ꜰ̲ʏ̲ ̲ʟ̲ɪ̲ɴ̲ᴋ̲ ̲ᴀ̲ɴ̲ᴅ̲ ̲ɢ̲ᴇ̲ᴛ̲ ̲ᴜ̲ɴ̲ʟ̲ɪ̲ᴍ̲ɪ̲ᴛ̲ᴇ̲ᴅ̲ ̲ᴀ̲ᴄ̲ᴄ̲ᴇ̲s̲s̲ ̲ꜰ̲ᴏ̲ʀ̲ ̲ᴛ̲ɪ̲ʟ̲ʟ̲ ̲ɴ̲ᴇ̲x̲ᴛ̲ ̲24̲ ̲H̲ᴏ̲ᴜ̲ʀ̲s̲

#Vᴇʀɪғɪᴄᴀᴛɪᴏɴ

Iғ Yᴏᴜ Wᴀɴᴛ Dɪʀᴇᴄᴛ Fɪʟᴇs Wɪᴛʜᴏᴜᴛ Aɴʏ Vᴇʀɪғɪᴄᴀᴛɪᴏɴ Tʜᴇɴ Bᴜʏ Bᴏᴛ Sᴜʙsᴄʀɪᴘᴛɪᴏɴ

💵 Sᴇɴᴅ /plan ᴛᴏ ᴘᴜʀᴄʜᴀsᴇ sᴜʙsᴄʀɪᴘᴛɪᴏɴ..</i></b>"""
...
ɪꜰ ʏᴏᴜ ꜰᴀᴄᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ, ᴛᴀᴋᴇ ᴀ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ᴀɴᴅ ꜱᴇɴᴅ ɪᴛ ᴛᴏ - @mrperfectjikabot
...
💳 ᴜᴘɪ ɪᴅ - <code>CLICK @payment_infoji IT</code>
